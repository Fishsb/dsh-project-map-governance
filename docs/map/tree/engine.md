...
- `engine/CHANGELOG.md` — (8.5 KB) 引擎演进史（v1→v3 规则引擎），随 skill 副本同步
...
- `engine/scripts/devref-card.mjs` — (7.9 KB) 项目知识卡库写门：三卡册+INDEX 入册（--init/--list/--title 写门，安全阀备份/限长/溯源/幂等）
...
- `engine/SKILL.md` — (19.5 KB) 引擎权威文档（设计/命令/配置/规则/边界）
